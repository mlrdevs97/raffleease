package com.raffleease.raffleease.Domains.Cart.Services.Impl;

import com.raffleease.raffleease.Domains.Cart.Model.Cart;
import com.raffleease.raffleease.Domains.Cart.Model.CartStatus;
import com.raffleease.raffleease.Domains.Cart.Repository.ICartsRepository;
...
import static com.raffleease.raffleease.Domains.Cart.Model.CartStatus.ACTIVE;

@RequiredArgsConstructor
@Service
public class CartsServiceImpl implements ICartsService {
    private final ICartsRepository repository;
    private final ITokensCreateService tokenCreateService;
